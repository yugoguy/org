...
to-report optimal-bet-position ; in bettor ; box
  report risk-neutral-herding-overconfident-info-sharing-constrained-decision
end
...
to-report risk-neutral-herding-overconfident-constrained-decision ; in bettor ; box
  set belief (belief * (1 - herding)) + (price-yes * herding)
...
to-report risk-neutral-herding-overconfident-info-sharing-constrained-decision ; in bettor ; box
...
to-report network-information-sharing [x]
  ...
  ifelse any? nbrs [
      let avg  (sum [ belief * (1 - ( (distance myself) / scale)) ] of nbrs) / (count nbrs)
